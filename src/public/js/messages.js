...
$('#more_fields').click(function(){
	$(this).before('<div class="NaamStyle"><input type="text" name="name" placeholder="Naam" class="form-control"/></div><div class="form-group"><input type="text" name="to" placeholder="Telefoonnummer (+316)" class="form-control"/></div>')
})